	...
	public void run() {
		...
		while(b) {	
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "The client connected.");
				...
				JOptionPane.showMessageDialog(null, "You experienced a Socket Timeout Exception.");
				b = false;
			} catch(IOException ioe) {
				JOptionPane.showMessageDialog(null, "You experienced an IO Exception.");
				b = false;
			}
